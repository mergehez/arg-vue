...
export { default as ConditionalWrapper } from './ConditionalWrapper.vue';
export { default as FallbackableImg } from './FallbackableImg.vue';
...
export { default as SplittedImg } from './SplittedImg.vue';

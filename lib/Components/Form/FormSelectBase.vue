...
<template>
    <label :for="id" :class="twMerge('form-control pl-3 py-1.5 pr-7 relative relative justify-start', props.class)">
        <select aria-labelledby="categories" :value="modelValue" @change="onChange" :id="id"
                class="absolute inset-0 opacity-0 cursor-pointer w-24 md:w-auto px-0">
